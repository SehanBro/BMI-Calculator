...
class App(MDApp):
    ...
    def github(self):
        webbrowser.open_new('https://github.com/SehanBro')

    def youtube(self):
        webbrowser.open_new_tab('https://www.youtube.com/channel/UCHxTeTgm2Ll9VtexbicMhCA')
    ...
    def build(self):
        ...
        self.toolbar.right_action_items=[['github',lambda g: self.github()],['youtube',lambda f:self.youtube()]]
        ...
        self.developer = MDLabel(text='Developed By Sehan Bro',font_size=10,pos_hint={'center_x': 1, 'center_y': 0.1 })
